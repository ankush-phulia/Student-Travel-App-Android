 ...
 * {@link LoginEmailFragment.OnLoginEmailFragmentInteractionListener} interface to handle
 * interaction events.
 */
public class LoginEmailFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        button_go_email.setOnClickListener(
    ...
    private void sendEmailDetails() {
        ...
        if (TextUtils.isEmpty(emailID) || !Patterns.EMAIL_ADDRESS.matcher(emailID).matches()) {
            Toast.makeText(
                            getActivity(),
                            "Enter a valid email address and then press Go",
                            Toast.LENGTH_SHORT)
                    .show();
        } 
