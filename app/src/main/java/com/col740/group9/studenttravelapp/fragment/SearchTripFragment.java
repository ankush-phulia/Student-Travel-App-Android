 ...
 * Use the {@link SearchTripFragment#newInstance} factory method to
...
public class SearchTripFragment extends Fragment {
     ...
     * @return A new instance of fragment SearchTripFragment.
     */
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.OnSearchTripFragmentInteraction(uri);
        }
    }
