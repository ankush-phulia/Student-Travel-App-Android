 ...
 * {@link SearchJourneyFragment.OnSearchJourneyFragmentInteractionListener} interface to handle
 * interaction events.
 */
public class SearchJourneyFragment extends Fragment
    ...
    public View onCreateView(
        ...
        SearchJourneyFragmentView =
                inflater.inflate(R.layout.fragment_search_journey, container, false);

        mRecyclerView =
                (RecyclerView)
                        SearchJourneyFragmentView.findViewById(
                                R.id.search_journey_card_recycler_view);
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            public MyViewHolder(View view) {
                ...
                send_join_request_button =
                        view.findViewById(R.id.search_journey_card_send_join_request_button);
            }
        }
